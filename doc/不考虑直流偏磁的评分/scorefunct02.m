function [R5,I,H]=scorefunct02() %当前状态评分
Input_data=xlsread('datawithoutbias.xlsx','C2:C20');%原始数据，数据顺序对应参数需求表,220kV
lower_data=zeros(13);
upper_data=zeros(13);
...
xlswrite('resultwithoutbias.xlsx',R5,'sheet1','B3:F3');
xlswrite('resultwithoutbias.xlsx',I,'sheet1','G3:G3');
xlswrite('resultwithoutbias.xlsx',H,'sheet1','H3:H3');
end
